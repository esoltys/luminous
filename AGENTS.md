...
- **Windows UI automation smoke test** (real backend/IPC/SQLite, Windows only): `bun run test:e2e:windows`. One-time setup needed — see [docs/TROUBLESHOOTING.md](docs/TROUBLESHOOTING.md).
