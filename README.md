...
> **Flathub submission in progress.** A Flatpak manifest is tracked in-repo at [`flatpak/io.github.esoltys.Luminous.yml`](./flatpak/io.github.esoltys.Luminous.yml) and built/linted in CI (see [#419](https://github.com/esoltys/luminous/issues/419)), but Luminous isn't published on Flathub yet — once it is, `flatpak install flathub io.github.esoltys.Luminous` will be added here as a third Linux install option alongside `.deb`/`.rpm`.
