export const en = {
  ...
  playerBar: {
    ...
    seekbarModeMoodbar: "Frequency bands mode — click to switch to waveform",
    moodbarLegend: "Frequency bands — blue = low (bass), amber = mid (vocals/snares/leads), white = high (hi-hats/cymbals/transients); taller bands carry more energy",
    songLabel: "Song",
    artistLabel: "Artist",
    albumLabel: "Album",
