export const en = {
  ...
  playlists: {
    ...
    activePlaylistInfoText: "One custom playlist can be marked Active at a time — it's the quick-add target for \"Add to Active Playlist\" throughout Luminous. Queue is Active by default until you choose another. Opening a playlist to browse it never changes which one is Active; click \"Make Active\" on a playlist to set it.",
