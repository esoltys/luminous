export const en = {
  ...
  settings: {
    ...
    folderHelpText: "Luminous keeps an eye on these folders for audio files (MP3, FLAC, M4A, and more). Press \"Rescan Library\" and it looks through them for new or changed songs to add to your collection. After the first scan, rescans are quick since Luminous only checks what's changed.",
    ...
    toolsHelpText: "\"Clean Up Missing Songs\" removes library entries for files no longer on disk and deletes any folders left empty. \"Organize Entire Library\" renames and moves your files into a folder structure based on a template you define, e.g. Album Artist / Year - Album / Track - Title.",
