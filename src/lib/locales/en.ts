export const en = {
  ...
  collection: {
    ...
    noTracksMatchQuery: "No tracks match your query:",
  ...
  settings: {
    ...
    ratingStyleHint: "Heart marks a track as a favourite; 5-star allows half-step ratings. Both use the same underlying rating.",
  ...
  playlists: {
    ...
    autoPlayTooltipOn: "Auto-Refill ON — keeps appending matching tracks as you reach the end. Click to disable.",
    autoPlayTooltipOff: "Auto-Refill OFF — stops at end of current batch. Click to enable continuous refill.",
    autoPlayBadgeTooltip: "Auto-Refill enabled — keeps appending matching tracks",
    ...
    populationModeTooltipFavourites: "Your top-rated tracks",
    populationModeTooltipFamiliar: "Biased toward your most-played tracks",
    populationModeTooltipDiscover: "Surfaces lesser-played tracks in your library",
  ...
  organizer: {
    ...
    scopeSelection: "Selected Tracks ({count})",
    ...
    noTracksToOrganize: "No tracks to organize.",
  ...
  smartPlaylistBuilder: {
    ...
    autoRefillHint: "Automatically queue matching tracks as playback nears the end",
    cancel: "Cancel",
