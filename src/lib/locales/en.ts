export const en = {
  ...
  songTags: {
    ...
    artistTagsHeading: "Artist Tags {count}",
    songTagsHeading: "Song Tags {count}",
    ...
    mergeToast: "Merged into \"{name}\" ({count} songs updated)",
    artistMergeToast: "Merged into \"{name}\" ({count} artists updated)",
