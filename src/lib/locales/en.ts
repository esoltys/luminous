export const en = {
  ...
  settings: {
    ...
    contextEnrichmentIntegrationTitle: "Context & Bio Enrichment",
    contextEnrichmentDesc: "Powers the Details pane's Context & Bio tab.",
    ...
    webdavTitle: "Remote WebDAV Libraries",
    webdavSubtitle: "Connect Nextcloud, ownCloud, or remote WebDAV servers for direct streaming.",
    addWebdavServer: "Add WebDAV Server",
