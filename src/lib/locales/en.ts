export const en = {
  ...
  artistDetail: {
    ...
    retrieveDetailsError: "Failed to retrieve artist details",
    fetchArtistImage: "Fetch Artist Image",
    fetchArtistImageTooltip: "Fetch an artist portrait from fanart.tv or Wikidata",
    fetchImageSuccessFanart: "Artist image fetched from fanart.tv",
    fetchImageSuccessWikidata: "Artist image fetched from Wikidata",
    fetchImageNoResults: "No artist image found",
    fetchImageError: "Failed to fetch artist image",
    pinHome: "Pin to Home",
