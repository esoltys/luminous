export const fr = {
  ...
  settings: {
    ...
    ratingStyleHint: "Le cœur marque une chanson comme favorite ; les 5 étoiles permettent des notes par demi-étoile. Les deux utilisent la même note sous-jacente.",
    ...
    updateCheckEnabledHint: "Vérifie régulièrement les nouvelles versions sur GitHub Releases pendant l'exécution.",
    updateAutoInstallLabel: "Télécharger et installer automatiquement les mises à jour",
    updateAutoInstallHint: "Télécharge automatiquement les nouvelles versions lorsqu'elles sont disponibles.",
  ...
  playlists: {
    ...
    populationModeTooltipAll: "Mix complet, mélangé à chaque fois",
    populationModeTooltipFavourites: "Vos titres les mieux notés",
    populationModeTooltipFamiliar: "Privilégie vos titres les plus écoutés",
    populationModeTooltipDiscover: "Fait ressortir les titres peu écoutés de votre bibliothèque",
  ...
  smartPlaylistBuilder: {
    ...
    autoRefillHint: "Ajoute automatiquement des chansons correspondantes lorsque la lecture approche de la fin",
    cancel: "Annuler",
