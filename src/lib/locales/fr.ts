export const fr = {
  ...
  settings: {
    ...
    installFormatLabel: "Format d'installation",
    updateCheckEnabledLabel: "Vérifier automatiquement les mises à jour",
    updateCheckEnabledHint: "Activez pour vérifier régulièrement les nouvelles versions sur GitHub Releases pendant l'exécution.",
    updateAutoInstallLabel: "Télécharger et installer automatiquement les mises à jour",
    updateAutoInstallHint: "Téléchargez et installez automatiquement les nouvelles versions lorsqu'elles sont disponibles.",
    ...
    autoUpdateReady: "Mise à jour auto prête",
  ...
  playlists: {
    ...
    bpmAutoPlaylist: "BPM",
    bpmDownTempo: "BPM Tempo lent",
    bpmMidTempo: "BPM Tempo moyen",
    bpmUptempo: "BPM Tempo rapide",
    bpmHighEnergy: "BPM Haute énergie",
    bpmExtreme: "BPM Extrême",
