export const fr = {
  ...
  settings: {
    ...
    aboutTechRustfft: "Analyse spectrale en temps réel, moodbars et lecture/écriture de tags audio.",
  ...
  playerBar: {
    ...
    seekbarModeMoodbar: "Mode bandes de fréquences — cliquez pour passer à la forme d'onde",
    moodbarLegend: "Bandes de fréquences — bleu = graves, ambre = médiums (voix/caisse claire/leads), blanc = aigus (charleston/cymbales/transitoires) ; plus la bande est haute, plus elle porte d'énergie",
    songLabel: "Chanson",
    artistLabel: "Artiste",
    albumLabel: "Album",
    bitrateLabel: "Débit",
