export const fr = {
  ...
  artistDetail: {
    ...
    fetchArtistImage: "Récupérer l'image de l'artiste",
    fetchArtistImageTooltip: "Récupérer un portrait de l'artiste depuis fanart.tv ou Wikidata",
    fetchImageSuccessFanart: "Image de l'artiste récupérée depuis fanart.tv",
    fetchImageSuccessWikidata: "Image de l'artiste récupérée depuis Wikidata",
    fetchImageNoResults: "Aucune image d'artiste trouvée",
    fetchImageError: "Échec de la récupération de l'image de l'artiste",
