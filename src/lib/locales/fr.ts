export const fr = {
  ...
  topNav: {
    ...
    toggleRightPanel: "Afficher le panneau d'infos (Ctrl+I)",
  ...
  collection: {
    ...
    sortLabelPopularity: "Popularité",
    ...
    columnFormat: "Format",
    columnYear: "Année",
    columnOriginalYear: "Année d'origine",
    columnGenre: "Genre",
    columnBitrate: "Débit",
    columnRating: "Note",
    ...
    columnMusicBrainzId: "ID MusicBrainz",
    booleanYes: "Oui",
    booleanNo: "Non",
    ...
    columnArtistTag: "Tag d'artiste",
    columnAlbum: "Album",
    tableHeaderFormat: "Format",
    tableHeaderYear: "Année",
    tableHeaderOriginalYear: "Année orig.",
    tableHeaderGenre: "Genre",
    tableHeaderArtistTag: "Tag d'artiste",
  ...
  settings: {
    ...
    weekStartHint: "Choisissez le jour à partir duquel les classements et statistiques hebdomadaires calculent la semaine.",
    ...
    folderItemRecursive: "Surveillance des modifications du dossier",
    ...
    badgeIconFolder: "Dossier",
    badgeIconDrive: "Disque",
    badgeIconCloud: "Cloud / NAS",
    badgeIconComputer: "Ordinateur",
    badgeIconUsb: "USB",
    badgeIconHome: "Accueil",
    badgeIconDisc: "Disque optique",
    badgeIconMusic: "Musique",
    badgeIconArchive: "Archive",
    badgeIconShared: "Partagé",
    badgeColorDefault: "Par défaut",
    badgeColorBlue: "Bleu",
    badgeColorPurple: "Violet",
    badgeColorPink: "Rose",
    badgeColorRed: "Rouge",
    badgeColorOrange: "Orange",
    badgeColorYellow: "Jaune",
    ...
    exportThemeShort: "Exporter",
    importTheme: "Importer un thème",
    themeImportSuccess: "Thème « {name} » importé avec succès",
    themeImportError: "Échec de l'importation du thème : {error}",
    themeExportSuccess: "Thème « {name} » exporté avec succès",
    themeExportError: "Échec de l'exportation du thème : {error}",
    ...
    contextEnrichmentHint: "Recherche les notes, tags, critiques et biographies d'artistes sur MusicBrainz, CritiqueBrainz et Wikipédia. Désactivez cette option pour garder Luminous entièrement hors ligne pour ces données.",
    fanartIntegration: "Intégration fanart.tv",
    fanartDesc1: "Luminous utilise ",
    fanartDesc2: " pour récupérer des portraits d'artistes lorsqu'aucun n'est trouvé localement. Sans clé API, Luminous se rabat sur l'image Wikidata de l'artiste, si elle existe.",
    fanartApiKeyLabel: "Clé API",
    ...
    webdavTitle: "WebDAV distant",
    webdavSubtitle: "Connectez-vous à des serveurs WebDAV distants pour la lecture en continu.",
    addWebdavServer: "Ajouter WebDAV",
    editWebdavServer: "Modifier le serveur WebDAV",
    webdavItemEdit: "Modifier les détails du serveur WebDAV",
    webdavStatusIdle: "Inactif",
    webdavStatusSyncing: "Synchronisation…",
    webdavStatusNeverSynced: "Jamais synchronisé",
    webdavStatusSynced: "Dernière synchronisation {time}",
    webdavStatusDisconnected: "Déconnecté (serveur injoignable ?)",
    webdavNextSyncIn: "Prochaine synchronisation auto dans {minutes} min",
    folderSyncNowBtn: "Synchroniser",
    folderSyncNowHint: "Lancer une analyse incrémentielle pour prendre en compte les changements de ce dossier maintenant.",
    webdavName: "Nom du serveur",
    webdavNamePlaceholder: "ex. Mon Nextcloud, NAS maison",
    webdavUrl: "URL du serveur",
    webdavUrlPlaceholder: "https://cloud.example.com/remote.php/webdav",
    webdavUsername: "Nom d'utilisateur",
    webdavUsernamePlaceholder: "Nom d'utilisateur (facultatif)",
    webdavPassword: "Mot de passe / Jeton d'application",
    webdavPasswordPlaceholder: "Mot de passe ou jeton d'application (facultatif)",
    webdavRemotePath: "Chemin du dossier distant",
    webdavAutoSyncLabel: "Synchronisation automatique",
    webdavAutoSyncHint: "Synchroniser périodiquement ce serveur pour les nouveaux morceaux sans cliquer sur Synchroniser.",
    webdavSyncIntervalLabel: "Synchroniser toutes les (minutes)",
    webdavTestBtn: "Tester la connexion",
    webdavTesting: "Test en cours...",
    webdavTestSuccess: "Connexion réussie !",
    webdavTestFailed: "Échec de la connexion : {error}",
    ...
    saveWebdavServer: "Enregistrer les modifications",
    subsonicTitle: "Serveurs multimédias",
    subsonicSubtitle: "Connectez-vous à Navidrome, Gonic ou tout serveur OpenSubsonic pour diffuser sa bibliothèque.",
    addSubsonicServer: "Ajouter un serveur",
    editSubsonicServer: "Modifier le serveur multimédia",
    subsonicItemEdit: "Modifier les détails du serveur multimédia",
    subsonicName: "Nom du serveur",
    subsonicNamePlaceholder: "ex. Navidrome maison",
    subsonicUrl: "URL du serveur",
    subsonicUrlPlaceholder: "https://musique.exemple.com",
    subsonicUsername: "Nom d'utilisateur",
    subsonicUsernamePlaceholder: "Nom d'utilisateur",
    subsonicPassword: "Mot de passe",
    subsonicPasswordPlaceholder: "Mot de passe",
    subsonicPasswordKeepPlaceholder: "Laissez vide pour conserver le mot de passe actuel",
    subsonicAuthMode: "Méthode de connexion",
    subsonicAuthModeHint: "Gardez Jeton sauf si votre serveur le refuse — choisissez Mot de passe pour les serveurs qui stockent des mots de passe hachés, ou Clé d'API si votre serveur vous en a fourni une",
    subsonicAuthToken: "Jeton (recommandé)",
    subsonicAuthPassword: "Mot de passe (ancien)",
    subsonicAuthApiKey: "Clé d'API",
    subsonicApiKey: "Clé d'API",
    subsonicApiKeyPlaceholder: "Clé d'API",
    subsonicApiKeyKeepPlaceholder: "Laissez vide pour conserver la clé d'API actuelle",
    subsonicAuthHttpWarning: "Ce serveur utilise http:// sans chiffrement, votre mot de passe est donc envoyé en clair. Utilisez https:// si votre serveur le prend en charge.",
    subsonicUsePasswordAuth: "Utiliser la connexion par mot de passe",
    subsonicReportPlaysLabel: "Signaler les écoutes",
    subsonicReportPlaysHint: "Envoyez les écoutes à ce serveur. Désactivez cette option si le serveur transmet déjà les écoutes à ListenBrainz ou Last.fm et que Luminous les scrobble aussi, pour éviter de compter chaque écoute deux fois.",
    subsonicTestSuccess: "Connecté à {server}.",
    subsonicTestSuccessUnknown: "Connexion réussie !",
    subsonicSyncComplete: "{added} ajoutés, {updated} mis à jour, {removed} retirés, {errors} erreurs",
    subsonicSyncFailed: "Impossible de synchroniser {name} : {error}",
    subsonicSaveFailed: "Impossible d'enregistrer le serveur : {error}",
  ...
  playlists: {
    ...
    contextMenuMarkNotIncluded: "Marquer comme non inclus",
    contextMenuIncludeInPlaylists: "Inclure dans les listes de lecture",
    markedNotIncluded: "{name} marqué(e) comme non inclus(e)",
    unmarkedNotIncluded: "{name} de nouveau inclus(e) dans les listes de lecture",
    notIncludedBadgeTooltip: "Non inclus dans les listes de lecture automatiques ni le remplissage automatique",
  ...
  playerBar: {
    ...
    loudnessSourceDynamicRangeLog: "Journal DR",
    loudnessSourceFallback: "Gain de secours",
    dynamicRangeLabel: "Plage dynamique",
    dynamicRangePeak: "Crête {value} dB",
    dynamicRangeRms: "RMS {value} dB",
    lyricsStatusLabel: "Paroles",
    lyricsSynced: "Synchronisées (LRC)",
    lyricsPlain: "Texte brut",
    lyricsNone: "Non téléchargées",
    musicbrainzSectionLabel: "MusicBrainz",
    musicbrainzArtistLabel: "Artiste",
    musicbrainzAlbumArtistLabel: "Artiste de l'album",
    musicbrainzReleaseLabel: "Édition",
    musicbrainzReleaseGroupLabel: "Groupe d'éditions",
    musicbrainzRecordingLabel: "Enregistrement",
    musicbrainzTrackLabel: "Piste",
    musicbrainzWorkLabel: "Œuvre",
    musicbrainzReleaseTypeLabel: "Type",
    musicbrainzReleaseCountryLabel: "Pays",
    barcodeLabel: "Code-barres",
    catalogNumberLabel: "N° de catalogue",
    nowPlayingHeading: "Lecture en cours",
    tabContextBio: "Informations",
    tabAudioTechnicals: "Technique",
    filePathLabel: "Chemin du fichier",
    wikipediaSectionLabel: "Wikipédia",
    mbTagsSectionLabel: "Tags de la communauté",
    ...
    listenbrainzAlbumLabel: "Album",
    listenbrainzRecordingLabel: "Morceau",
  ...
  songTags: {
    ...
    artistTagsHeading: "Tags artiste",
    songTagsHeading: "Tags de chansons",
    goToArtistTagTooltip: "Parcourir {tag}",
    noGenre: "Sans genre",
    changeColorTooltip: "Changer la couleur",
    dragCardTooltip: "Glisser pour en faire un sous-genre d'une autre carte",
    dragArtistCardTooltip: "Glisser pour en faire un sous-tag d'une autre carte",
    sortName: "Nom",
    sortSongCount: "Nombre de chansons",
    noSubgenresYet: "Aucun sous-genre pour l'instant — glissez un tag ici",
    noArtistSubtagsYet: "Aucun sous-tag pour l'instant — glissez un tag ici",
    selectedCount: "{count} sélectionné(s)",
    newArtistGroup: "Nouveau groupe",
    groupSelected: "Grouper la sélection",
    createGroupTitle: "Créer un groupe de tags",
    createGroupPrompt: "Nom du groupe",
    createGroupBtn: "Créer",
    groupSelectedTitle: "Grouper les tags sélectionnés",
    groupToast: "{count} tags groupés sous « {name} »",
    ...
    promoteArtistTag: "Promouvoir en tag principal",
    renameToast: "Renommé en « {name} » ({count} chansons mises à jour)",
    artistRenameToast: "Renommé en « {name} » ({count} artistes mis à jour)",
    deleteConfirmMessage: "Supprimer {count} tag(s) de toutes les chansons qui les portent ? Cette action est irréversible.",
    artistDeleteConfirmMessage: "Supprimer {count} tag(s) de tous les artistes qui les portent ? Cette action est irréversible.",
    deleteBtn: "Supprimer",
    cancelBtn: "Annuler"
  },
  ...
  tagEditor: {
    ...
    remoteSourceNote: "Ce morceau se trouve sur un serveur distant. Les modifications ne sont enregistrées que dans Luminous — le fichier sur le serveur ne sera pas modifié.",
  ...
  albumTagEditor: {
    ...
    openFolderBtn: "Ouvrir le dossier",
    openFolderFailedPrefix: "Échec de l'ouverture du dossier : ",
    remoteSourceNote: "Cet album se trouve sur un serveur distant. Les modifications ne sont enregistrées que dans Luminous — les fichiers sur le serveur ne seront pas modifiés.",
  ...
  artistDetail: {
    ...
    retrieveArtistImageTooltip: "Récupérer un portrait de l'artiste depuis fanart.tv ou Wikidata",
  ...
  artistProfileEditor: {
    ...
    noLinks: "Aucun lien ajouté pour le moment. Cliquez sur « Ajouter un lien » pour joindre des profils de réseaux sociaux ou de streaming.",
  ...
  albumProfileEditor: {
    ...
    website: "Page officielle / Boutique",
    ...
    addTagBtn: "Ajouter",
    removeTagTooltip: "Supprimer {tag}",
  ...
  organizer: {
    ...
    destinationDefault: "Par défaut : même bibliothèque",
    destinationCustom: "Personnalisé...",
    browse: "Parcourir...",
    ...
    statusSummary: "Statut : {errors} erreurs, {missingTags} tags manquants, {duplicates} doublons, {ready} prêts",
    colSource: "Ancien emplacement",
    colDestination: "Nouvel emplacement",
    colStatus: "Statut",
    statusOk: "Prêt",
    ...
    noChangingFilesMatch: "Aucun fichier n'a besoin d'être réorganisé.",
  ...
  picard: {
    ...
    remoteNotSupportedTooltip: "Ouvrir dans Picard n'est pas disponible pour les morceaux sur un serveur distant",
  ...
  listenbrainz: {
    ...
    userTokenPlaceholder: "Collez votre jeton utilisateur ListenBrainz",
    getTokenLink: "Obtenir votre jeton",
    validateBtn: "Valider et enregistrer",
    statusConnected: "Connecté",
    statusPaused: "Scrobbling en pause",
  ...
  smartPlaylistBuilder: {
    ...
    fieldArtist: "Artiste",
    fieldArtistTag: "Tag d'artiste",
    fieldAlbum: "Album",
    fieldTitle: "Titre",
    fieldGenre: "Genre",
    fieldFolder: "Dossier / Chemin",
  ...
  audioPipeline: {
    ...
    qualityTier: "Qualité",
    tierLq: "Basse qualité",
    tierSq: "Qualité standard",
    tierHq: "Haute qualité",
    tierHiRes: "Audio Hi-Res",
    tierLqDesc: "Format avec perte inférieur à 256 kbps",
    tierSqDesc: "Format avec perte à 256 kbps ou plus",
    tierHqDesc: "Format sans perte",
    tierHiResDesc: "Format sans perte avec fréquence d'échantillonnage supérieure à 48 kHz ou résolution supérieure à 16 bits",
    stageInput: "Entrée",
    stageProcessing: "Traitement",
    stageOutput: "Sortie",
    sourceLocal: "Fichier local",
    sourceRemote: "Partage réseau",
    sourceStream: "Flux Internet",
    codec: "Codec",
    ...
    channels: "Canaux",
    decoder: "Décodeur",
    headroom: "Marge de dynamique",
    resampling: "Rééchantillonnage",
    resamplingDirect: "Direct (sans rééchantillonnage)",
    resamplingTo: "Rééchantillonné à {rate}",
    volumeNormalization: "Normalisation du volume",
    normalizationDisabled: "Désactivée",
    normalizationGain: "{gain} dB ({source})",
    ...
    outputBackend: "Moteur audio",
    close: "Fermer la chaîne audio",
    inspectPipeline: "Examiner la chaîne audio",
