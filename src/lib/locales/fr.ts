export const fr = {
  ...
  settings: {
    ...
    folderHelpText: "Luminous surveille ces dossiers à la recherche de fichiers audio (MP3, FLAC, M4A, et plus). Appuyez sur « Analyser la bibliothèque » et Luminous y cherche les chansons nouvelles ou modifiées à ajouter à votre collection. Après la première analyse, les suivantes sont rapides, car Luminous ne vérifie que ce qui a changé.",
    ...
    toolsHelpText: "« Nettoyer les chansons manquantes » supprime les entrées de la bibliothèque pour les fichiers qui ne sont plus sur le disque et nettoie les dossiers devenus vides. « Organiser toute la bibliothèque » renomme et déplace vos fichiers selon un modèle que vous définissez, par ex. Artiste de l'album / Année - Album / Piste - Titre.",
