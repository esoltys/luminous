export const fr = {
  ...
  playlists: {
    ...
    exportBtn: "Exporter",
    cancelBtn: "Annuler",
    filterPlaceholder: "Filtrer les pistes...",
    ...
    autoPlayBadgeTooltip: "Lecture automatique activée — ajoute le lot suivant",
    refreshAutoPlaylistTooltip: "Actualiser la liste automatique avec une nouvelle sélection de titres de votre bibliothèque",
