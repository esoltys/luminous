export const fr = {
  ...
  settings: {
    ...
    contextEnrichmentIntegrationTitle: "Enrichissement contextuel et biographique",
    contextEnrichmentDesc: "Alimente l'onglet Informations du panneau de détails.",
    ...
    webdavTitle: "Bibliothèques WebDAV distantes",
    webdavSubtitle: "Connectez Nextcloud, ownCloud ou un serveur WebDAV pour la lecture en continu.",
    addWebdavServer: "Ajouter un serveur WebDAV",
