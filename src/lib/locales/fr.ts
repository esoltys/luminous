export const fr = {
  ...
  songTags: {
    ...
    artistTagsHeading: "Tags artiste {count}",
    songTagsHeading: "Tags de chansons {count}",
    ...
    mergeDialogTitle: "Fusionner les tags",
    mergeDialogPrompt: "Quel nom souhaitez-vous conserver ?",
    mergeToast: "Fusionné dans « {name} » ({count} chansons mises à jour)",
    artistMergeToast: "Fusionné dans « {name} » ({count} artistes mis à jour)",
