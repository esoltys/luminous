export const fr = {
  ...
  settings: {
    ...
    rescanSubtitle: "Effectuez des rebalayages incrémentiels ou complets, configurez l'analyse automatique et nettoyez les fichiers manquants.",
    ...
    pruneMissingBtn: "Nettoyer les pistes manquantes",
    pruneMissingHint: "Marque indisponibles les pistes dont les fichiers audio ont été déplacés ou supprimés du disque",
    pruneCompleteMsg: "{count} piste(s) manquante(s) nettoyée(s)",
