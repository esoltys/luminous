export const fr = {
  ...
  collection: {
    ...
    allFilteredOutTitle: "Tous les résultats sont filtrés",
    noTracksMatchQuery: "Aucune piste ne correspond à votre recherche :",
  ...
  playlists: {
    ...
    populationModeFamiliar: "Familier",
  ...
  organizer: {
    ...
    scopeLabel: "Portée",
    scopeSelection: "Pistes sélectionnées ({count})",
    ...
    noTracksToOrganize: "Aucune piste à organiser.",
  ...
  smartPlaylistBuilder: {
    ...
    autoRefillHint: "Ajoute automatiquement des pistes correspondantes lorsque la lecture approche de la fin",
    cancel: "Annuler",
