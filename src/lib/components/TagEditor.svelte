      ...
      {:else}
        <div class="flex flex-col gap-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <FormField label={i18n.t('tagEditor.genreField')} for="tag-genre" tooltip={i18n.t('tagEditor.genreTooltip', {}, 'Drag chips to reorder — the first value is treated as the main genre in the Genres tab, the rest as subgenres of it.')}>
              <ChipInput
                id="tag-genre"
                bind:value={genre}
                disabled={isSaving}
