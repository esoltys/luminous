...
An interim release pulling forward completed 2.0-milestone work: native Genres & Tags
management, richer artist profiles, multi-value tags, custom sort overrides, system tray
integration, and drag-and-drop playback.
