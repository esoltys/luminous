...
| :--- | :--- | :--- | :--- | :--- |
| **Search/Filter** | Query: `"Special"` | 8.240 ms | 1000 | Passed |
| **Sort** | Title (Ascending) | 491.541 ms | 100,000 | Passed |
| **Sort** | Artist (Descending) | 810.435 ms | 100,000 | Passed |
| **Sort** | Duration (Ascending) | 709.734 ms | 100,000 | Passed |

## Rendering Performance (DOM Mounting)

| Component | Target / List Type | Avg Mount Time (JSDOM) | Virtualization Status | FPS |
| :--- | :--- | :--- | :--- | :--- |
| **CollectionView** | Tracks (`VirtualList`) | 859.88 ms | Active (`svelte-virtual-list-ts`) | ~60 FPS |
